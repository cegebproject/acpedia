...
<head>
  ...
  <title>ACPEDIA Control Panel</title>
  <!--favicon-->
	<link rel="icon" href="acpico.png" type="image/png">
        ...
        <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center">
          <div class="card rounded-0 m-3 mb-0 border-0 shadow-none">
            <div class="card-body p-sm-5">
              <img src="acp.png" class="mb-4" width="145" alt="">
              <h4 class="fw-bold">ACPEDIA Control Panel</h4>
              <p class="mb-0">Masukkan email akun admin/teknisi Anda</p>

         
    
              <div class="form-body mt-4">
                <form class="row g-3" action="<?= base_url('auth/attemptLogin') ?>" method="post">
    <?= csrf_field() ?>
                    
                  <div class="col-12">
                    <label for="inputEmailAddress" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="inputEmailAddress" placeholder="emailanda@acpedia.id">
                  </div>
                  <div class="col-12">
